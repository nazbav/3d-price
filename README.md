...
6. **calc-fluidd/** – версия для интеграции с Fluidd (расширенный калькулятор)

Онлайн‑версию можно открыть по ссылке: <https://nazbav.github.io/3d-price/test.html> (см. раздел *Навигация и разделы*).

**Версия для Fluidd:** Специально организованная версия расширенного калькулятора для интеграции с Fluidd находится в папке `calc-fluidd/`. Эта версия идентична `test.html` по функциональности, но размещена в отдельной директории для удобства интеграции.
