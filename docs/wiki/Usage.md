...
8. В таблице моделей нажмите на иконку, чтобы загрузить миниатюру модели. PNG-файл будет уменьшен до 140×110 и сохранён в Base64. При расчёте такие строки обрабатываются корректно.
9. Для массового удаления и изменения элементов используйте одноимённые кнопки на страницах списков.
