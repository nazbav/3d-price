...
10. Профили материалов Orca доступны глобально. В окне настроек материала выпадающий список сразу показывает все доступные профили, их можно выбрать или создать новый через кнопку добавления. Выбор профиля сохраняется корректно.
