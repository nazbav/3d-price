...
`index.html` — экспериментальный калькулятор себестоимости 3D‑печати. Страница содержит все актуальные функции и формулы, описанные в README. Другие HTML‑файлы репозитория отражают более ранние версии интерфейса.
