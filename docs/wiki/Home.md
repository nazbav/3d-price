...
Дополнительные возможности включают импорт/экспорт JSON, синхронизацию через Supabase и генерацию этикеток. В разделе «Брендинг» можно загрузить PNG‑логотип компании.
