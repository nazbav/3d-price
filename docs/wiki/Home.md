...
Дополнительные возможности включают импорт/экспорт JSON, синхронизацию через Supabase и генерацию этикеток. В таблице расчёта модели можно загрузить миниатюру (PNG 140×110), кликнув по иконке; расчёт стоимости учитывает такие строки.
