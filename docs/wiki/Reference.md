...
- `materialProfiles` — глобальный набор профилей материалов Orca, связываемых с материалами по `profileIds`. Любой профиль можно назначить нескольким материалам.
