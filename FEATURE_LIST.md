...
- Создана папка modern с переработанной версией test.html и локальными стилями
- В каталоге modern теперь лежит полная версия калькулятора с актуальной функциональностью
