...
- В AGENTS.md добавлены инструкции по тестированию калькулятора в Ubuntu через index.html
...
- Модальное окно OrcaSlicer заполняется корректно; атрибут data-inited больше не блокирует поля.
- Исправлено отображение модальных окон "Профиль" и "Профили Orca" в index.html
