...
- Добавлена интеграция со Spoolman: в настройках новый раздел и двусторонняя синхронизация остатков материалов.
- Улучшена совместимость с API Spoolman: исправлены пути и поля
